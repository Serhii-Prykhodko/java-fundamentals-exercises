...
public class CrazyStreams {
    ...
    public List<Account> sortByFirstAndLastNames() {
        ...
        Comparator<Account> comparatorByFirstAndLastNames =
                Comparator.comparing(Account::getFirstName).thenComparing(Account::getLastName);

        return accounts.stream()
                .sorted(comparatorByFirstAndLastNames)
                .toList();
    }
    ...
    public BigDecimal getBalanceByEmail(String email) {
        return accounts.stream()
                ...
                .map(Account::getBalance)
                .findFirst().orElseThrow(() -> new EntityNotFoundException("Cannot find Account by email=" + email));
    }
    ...
    public Map<Month, String> groupCommaSeparatedFirstNamesByBirthdayMonth() {
        return accounts.stream()
                .collect(Collectors.groupingBy(a -> a.getBirthday().getMonth(), Collectors.mapping(Account::getFirstName, Collectors.joining(", "))));
    }
